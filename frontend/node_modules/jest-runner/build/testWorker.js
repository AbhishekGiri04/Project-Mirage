'use strict';
/* build-hook-start *//*00001*/try { require('/Users/abhishekgiri/.vscode/extensions/wallabyjs.console-ninja-1.0.501/out/buildHook/index.js').default({tool: 'jest', checkSum: '20d2dfe0cd9a7d8d61859fVgVKU0sBWVYMB1NTAVwGAVpQCgVX', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///Users/abhishekgiri/.vscode/extensions/wallabyjs.console-ninja-1.0.501/out/buildHook/index.js').then(m => m.default.default({tool: 'jest', checkSum: '20d2dfe0cd9a7d8d61859fVgVKU0sBWVYMB1NTAVwGAVpQCgVX', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
